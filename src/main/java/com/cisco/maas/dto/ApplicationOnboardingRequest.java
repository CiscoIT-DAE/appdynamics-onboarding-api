...
/**
 * This class contains Onboarding appD application request properties and its setters and getters.
  */
public class ApplicationOnboardingRequest {
	...
	public String toString() {
		return "ApplicationOnboardingRequest [ apmApplicationGroupName = " + apmApplicationGroupName
				+ ", adminUsers=" + adminUsers + ", viewUsers=" + viewUsers + ", apmLicenses=" + apmLicenses + ", eumApplicationGroupNames="
